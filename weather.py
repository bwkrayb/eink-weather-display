import os
import time
##from libs import AbstractScreen
...
try:
    ...
    draw.text((condIndent, 85), cond.title(), font=condText, fill=0, align='left')
    draw.text((timeIndent, 140), time, font=timeText, fill=0, align='left')
